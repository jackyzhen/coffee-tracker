...
class SmartTable extends Component {
  ...
  render() {
    const { total, tableHeaders, isLoading, onRowSelect } = this.props;
    const { offset, limit, page } = this.state;

    const processedData = processTableData(page);

    return (
      <Table className={styles.table} onRowSelection={onRowSelect} selectable>
        ...
        <TableBody showRowHover displayRowCheckbox={false} preScanRows>
          {
